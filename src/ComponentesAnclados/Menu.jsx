...
export  function Menu() {
  ...
  const{ setProductosFiltrados, productosOriginales, isLoading} =useContext(ProductosContext)
 ...
 if(idCategoria){
    const nuevaLista=productosOriginales.filter((prod)=>prod.idCategoria===parseInt(idCategoria))
  ...
  return (
    <>
        ...
        <ul className='menu1'>
          ...
          <div className='item' onClick={()=>selectCategoria(categoria.idCategoria)}>
